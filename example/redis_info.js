 ...
 * Helpers
 */
function join(sep){return function(v){return v.join(sep);};};
function printDatabase(v){return Object.keys(v).map(function(key){return key + ': ' + v[key];}).join('\n')+ "\n___________\n";}
function print(array, mapper){return '\n'+array.map(mapper).join('\n');}
